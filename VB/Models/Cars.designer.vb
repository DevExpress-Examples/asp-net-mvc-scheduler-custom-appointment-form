...
Namespace DevExpressMvcApplication1.Models
    ...
    Public Partial Class CarsDataContext
...
#Region "Extensibility Method Definitions"
        ...
        Partial Private Sub InsertCarScheduling(ByVal instance As DevExpressMvcApplication1.Models.CarScheduling)
        End Sub

        Partial Private Sub UpdateCarScheduling(ByVal instance As DevExpressMvcApplication1.Models.CarScheduling)
        End Sub

        Partial Private Sub DeleteCarScheduling(ByVal instance As DevExpressMvcApplication1.Models.CarScheduling)
        End Sub

#End Region
        Public Sub New()
            MyBase.New(Global.System.Configuration.ConfigurationManager.ConnectionStrings(CStr(("CarsDBConnectionString"))).ConnectionString, DevExpressMvcApplication1.Models.CarsDataContext.mappingSource)
            Me.OnCreated()
        End Sub

        Public Sub New(ByVal connection As String)
            MyBase.New(connection, DevExpressMvcApplication1.Models.CarsDataContext.mappingSource)
            Me.OnCreated()
        End Sub
        ...
        Public ReadOnly Property Cars As System.Data.Linq.Table(Of DevExpressMvcApplication1.Models.Car)
            Get
                Return Me.GetTable(Of DevExpressMvcApplication1.Models.Car)()
            End Get
        End Property

        Public ReadOnly Property CarSchedulings As System.Data.Linq.Table(Of DevExpressMvcApplication1.Models.CarScheduling)
            Get
                Return Me.GetTable(Of DevExpressMvcApplication1.Models.CarScheduling)()
            End Get
        End Property
    End Class
...
#End Region
        ...
        Public Property ContactInfo As String
            ...
            Set(ByVal value As String)
                If(Not Equals(Me._ContactInfo, value)) Then
        ...
        Protected Overridable Sub SendPropertyChanging()
            RaiseEvent PropertyChanging(Me, DevExpressMvcApplication1.Models.CarScheduling.emptyChangingEventArgs)
        End Sub
